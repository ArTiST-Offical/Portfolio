const TRAININGS = [
  ...
  },
  {
    ...
    badge: "BTF",
    desc: "Hands-on defensive security training covering threat detection, log analysis, SIEM operations, incident response, network monitoring, and blue team methodologies for protecting enterprise environments.",
    tags: ["Blue Team", "Defense", "SIEM", "Incident Response"],
    color: "#2563eb",
  },
  {
    name: "Purple Team Fundamentals",
    provider: "CyberWarfare Labs",
    badge: "PTF",
    desc: "Integrated offensive and defensive security training bridging red and blue team perspectives. Covers adversarial simulation, detection engineering, and collaborative threat modeling for mature security operations.",
    tags: ["Purple Team", "Threat Simulation", "Detection Engineering"],
    color: "#c026d3",
  },
];
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1rem", maxWidth: "800px" }}>
        {TRAININGS.map((training, i) => (
          <div
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLDivElement).style.borderColor = `${training.color}80`;
          ...
          >
            ...
            >
              <span style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.5rem", color: training.color, letterSpacing: "0.04em", textAlign: "center", lineHeight: 1.3 }}>
                {training.badge}
              </span>
            </div>

            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: "'Space Mono', monospace", fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#fff", marginBottom: "0.3rem" }}>
                {training.name}
              </p>
              <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "0.75rem", color: training.color, marginBottom: "0.6rem", letterSpacing: "0.03em" }}>
                {training.provider}
              </p>
              <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "0.8rem", color: "rgba(255,255,255,0.6)", lineHeight: 1.65, marginBottom: "0.75rem" }}>
                {training.desc}
              </p>
